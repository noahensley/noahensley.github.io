...
{
    /// <summary>
    /// Emits an x86-64 bitwise AND instruction operating on two integer registers.
    /// </summary>
    /// <remarks>
    /// Emits <c>andq right, left</c> in AT&amp;T syntax. The result is stored in the
    /// left register. Both operands must be 64-bit integer registers.
    /// </remarks>
    public class OpBitAnd : Op
    {
        ...
        public OpBitAnd(IntRegister left, IntRegister right)
        {
            this.left = left;
            this.right = right;
        }
        ...
        /// </summary>
        /// <returns>A string of the form <c>andq right, left</c>.</returns>
